...
function SignUp() {
  ...
  const signUpEndpoint = "http://localhost:5000/api/signup"; // Replace with the actual URL
  const signInEndpoint = "http://localhost:5000/api/signin"; // Replace with the actual URL
